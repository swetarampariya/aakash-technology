...
if($_POST){
    ...
    $q=mysqli_query($connection,"insert into tbl_student(st_name,st_gender,st_dob,st_email,st_mobile,st_address,st_password,st_area,st_bloodgrood) values( '{$name}','{$gender}','{$dob}','{$email}','{$mobile}','{$address}','{$password}','{$area}','{$bloodgroup}')") or die(mysqli_error($connectionconnection));
...
<html>
    <body>
        ...
        <div style="background-image:url('pic1.jpg');"><br><br>
            Name : <input type = "text" text-align:center  name = "txt1"/><br><br>
            ...
            <input type = "submit"/><br><br><br><br><br><br><br><br><br>
